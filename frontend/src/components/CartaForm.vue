    ...
    <b-form enctype="multipart/form-data" @submit.prevent="$emit('processCarta', carta)">
        <b-row class="mt-3">
            ...
            <b-form-group>
                ...
                <b-form-invalid-feedback if="cartaInfo" v-if="$v.carta.$dirty">
                    Este campo es requerido y debe ser mayor a 4 caracteres
        ...
        <b-row class="mt-1">
            <b-col sm="2">
                <div class="mb-1">Intermediario: <strong>{{ carta.intermediario }}</strong></div>
            </b-col>
            <b-col sm="10">
        ...
        <b-row class="mt-1">
            <b-col sm="2"> 
                <div class="mb-1">Rem. Comerc: <strong>{{ carta.remitente_comercial }}</strong></div>
            </b-col>
            <b-col sm="10"> 
        ...
        <b-row class="mt-1">
            <b-col sm="2">
                <div class="mb-1">Corr. comprador: <strong>{{ carta.corredor_comprador }}</strong></div>
            </b-col>
            <b-col sm="10">
        ...
        <b-row class="mt-1">
            <b-col sm="2">    
                <div class="mb-1">MAT: <strong>{{ carta.mercado_a_termino }}</strong></div>
            </b-col>
            <b-col sm="10">
        ...
        <b-row class="mt-1">
            <b-col sm="2">
                <div class="mb-1">Corr. Vendedor: <strong>{{ carta.corredor_vendedor }}</strong></div>
            </b-col>
            <b-col sm="10">
        ...
        <b-row class="mt-1">
            <b-col sm="2">
                <div class="mb-1">Entregador: <strong>{{ carta.entregador }}</strong></div>
            </b-col>
            <b-col sm="10">
        ...
        <b-row class="mt-1">
            <b-col sm="2">
                <div class="mb-1">Destinatario: <strong>{{ carta.destinatario }}</strong></div>
            </b-col>
            <b-col sm="10">
        ...
        <b-row class="mt-1">
            <b-col sm="2">
                <div class="mb-1">Destino: <strong>{{ carta.destino }}</strong></div>
            </b-col>
            <b-col sm="10">
        ...
        <b-row class="mt-1">
            <b-col sm="2">
                <div class="mb-1">Intermediario Flete: <strong>{{ carta.interm_flete }}</strong></div>
            </b-col>
            <b-col sm="10">
        ...
        <b-row class="mt-1">
            <b-col sm="2">
                <div class="mb-1">Transportista: <strong>{{ carta.transportista }}</strong></div>
            </b-col>
            <b-col sm="10">
                <b-form-select 
        ...
        <b-row class="mt-1">
            <b-col sm="2">
                <div class="mb-1">Chofer: <strong>{{ carta.chofer }}</strong></div>
            </b-col>
            <b-col sm="10">
    ...
    methods: {
       ...
       async fetchChofer(){         
        ...
        async changeTrans(){
            ...
            var res = [];
            if(response){
                res = response.data.filter(data => data.transportista == this.carta.transportista);
                //console.log(res);
